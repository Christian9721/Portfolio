...
const SvgComponent = (props: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      <style>
        {".a,.c{fill:#c21325}.a,.b{stroke:#fff;stroke-width:20px}.b{fill:none}"}
      </style>
    </defs>
    ...
    <path
      ...
      className="b"
    />
    <circle cx={198.99} cy={216.58} r={40.95} className="c" />
    <circle cx={198.99} cy={216.58} r={40.95} className="b" />
    <circle cx={332.37} cy={216.58} r={40.95} className="a" />
    <circle cx={332.37} cy={216.58} r={40.95} className="b" />
    <circle cx={65.1} cy={216.88} r={40.94} className="c" />
    <circle cx={65.1} cy={216.88} r={40.94} className="b" />
  </svg>
);
