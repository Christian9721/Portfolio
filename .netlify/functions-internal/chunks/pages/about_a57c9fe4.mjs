...
import 'clsx';
import { m as markdownify, $ as $$Base } from './404_f8ee78ae.mjs';
...
}, "D:/Github/portafoliocv/node_modules/astro/components/Image.astro", void 0);
...
}, "D:/Github/portafoliocv/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/squoosh","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///D:/Github/portafoliocv/dist/");
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!(Object.assign({"BASE_URL":"/","MODE":"production","DEV":false,"PROD":true,"SSR":true,"SITE":"https://christianAvila9721.github.io","ASSETS_PREFIX":undefined},{Path:process.env.Path,}))?.DEV && cacheEntriesByCollection.has(collection)) {
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/about/-index.md": () => import('../-index_84b587f1.mjs'),"/src/content/blog/-index.md": () => import('../-index_18e24b31.mjs'),"/src/content/blog/post-1.md": () => import('../post-1_201a596e.mjs'),"/src/content/homepage/-index.md": () => import('../-index_f533593f.mjs'),"/src/content/pages/elements.mdx": () => import('../elements_b9f31b01.mjs'),"/src/content/pages/privacy-policy.md": () => import('../privacy-policy_013e3264.mjs')});
...
let lookupMap = {};
lookupMap = {"about":{"type":"content","entries":{"-index":"/src/content/about/-index.md"}},"blog":{"type":"content","entries":{"-index":"/src/content/blog/-index.md","post-1":"/src/content/blog/post-1.md"}},"homepage":{"type":"content","entries":{"-index":"/src/content/homepage/-index.md"}},"pages":{"type":"content","entries":{"privacy-policy":"/src/content/pages/privacy-policy.md","elements":"/src/content/pages/elements.mdx"}}};
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/about/-index.md": () => import('../-index_cf8d4cd1.mjs'),"/src/content/blog/-index.md": () => import('../-index_db2c9bde.mjs'),"/src/content/blog/post-1.md": () => import('../post-1_ab7f5594.mjs'),"/src/content/homepage/-index.md": () => import('../-index_cee625ce.mjs'),"/src/content/pages/elements.mdx": () => import('../elements_b7bf2a85.mjs'),"/src/content/pages/privacy-policy.md": () => import('../privacy-policy_1daa8e70.mjs')});
...
}, "D:/Github/portafoliocv/src/pages/about.astro", void 0);

const $$file = "D:/Github/portafoliocv/src/pages/about.astro";
