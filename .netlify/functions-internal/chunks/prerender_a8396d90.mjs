...
/* empty css                          */import { $ as $$Base, c as config, h as humanize, s as slugify, p as plainify } from './pages/404_1dee3211.mjs';
import { useStore } from '@nanostores/react';
import { atom } from 'nanostores';
import { g as getTaxonomy, a as getAllTaxonomy, $ as $$PageHeader, b as getSinglePage } from './pages/index_faa2dd60.mjs';
import 'clsx';
import { Carousel, IconButton } from '@material-tailwind/react';
import { $ as $$Image } from './pages/about_003918e4.mjs';
...
function CartButton() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "mx-12 lg:mx-0", children: /* @__PURE__ */ jsxs("p", { className: "mb-8 items-center justify-center lg:justify-start", children: [
...
const Venn1 = new Proxy({"src":"/_astro/venn1.7e3737f0.png","width":1347,"height":645,"format":"png"}, {
...
const Currie1 = new Proxy({"src":"/_astro/currie1.ca63c95f.png","width":1892,"height":1071,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const CELE = new Proxy({"src":"/_astro/index.1e63f4a1.png","width":1347,"height":645,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Currie2 = new Proxy({"src":"/_astro/currie2.7af6c235.png","width":1544,"height":852,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Venn2 = new Proxy({"src":"/_astro/venn2.352ef89f.PNG","width":723,"height":359,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Venn3 = new Proxy({"src":"/_astro/venn3.f03850a3.png","width":1341,"height":643,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Venn4 = new Proxy({"src":"/_astro/venn4.53360b1f.PNG","width":1339,"height":516,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Venn5 = new Proxy({"src":"/_astro/venn5.be87c38b.PNG","width":1349,"height":573,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Accesos1 = new Proxy({"src":"/_astro/accesos1.269b33da.png","width":1126,"height":582,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Accesos2 = new Proxy({"src":"/_astro/accesos2.0ccc35ae.png","width":1293,"height":1239,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Accesos3 = new Proxy({"src":"/_astro/accesos3.10050375.png","width":1277,"height":730,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Accesos4 = new Proxy({"src":"/_astro/accesos4.cdbdece0.png","width":1501,"height":1256,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Accesos5 = new Proxy({"src":"/_astro/accesos5.662f6123.png","width":1709,"height":792,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan2 = new Proxy({"src":"/_astro/nissan2.c4cad0dc.png","width":1015,"height":759,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan1 = new Proxy({"src":"/_astro/nissan1.c2c3bc22.png","width":1014,"height":758,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan3 = new Proxy({"src":"/_astro/nissan3.8a8a8730.png","width":1016,"height":759,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan4 = new Proxy({"src":"/_astro/nissan4.279ef01f.png","width":1017,"height":761,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan5 = new Proxy({"src":"/_astro/nissan5.4c7feb04.png","width":1019,"height":761,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Nissan6 = new Proxy({"src":"/_astro/nissan6.deb936fb.png","width":1018,"height":759,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Projects = {
  ...
  cele: {
    ...
    srcImg: CELE.src,
    tools: ["Vue", "SCSS", "Tailwind", "Javascript", "Git", "Webpack"],
  ...
  accesos: {
    ...
    srcImg: Accesos1.src,
    tools: ["Git", "React", "Typescript", "Jest"],
  ...
  nissan: {
    ...
    srcImg: Nissan2.src,
    tools: ["Unity", "Git"],
    endDate: /* @__PURE__ */ new Date("2022-06-20"),
    otherImgs: [
      Nissan1.src,
      Nissan2.src,
      Nissan3.src,
...
const Experience = [
  {
    timePeriod: "JUL 2022 – AUG 2023",
    title: "Frontend Developer MID / API Manager",
...
efficiency of organizations with innovation processes and pinpointed solutions in IT, Facilities, Supply Chain.`,
    projects: [],
    achievements: [
      {
...
Omaha, focusing on utilizing React to meet project objectives.`
      },
      {
        ...
        description: `Developed commands with regex to automate tasks within the hospital management
...
maintainable, and efficient code, ensuring the longevity of the software.`
  ...
  },
  {
    ...
    description: `I developed the website for the Durango State Language School University (CELE) using Vue, Tailwind, and Sass.
...
const $$file$3 = "D:/Github/portafolio_cv/src/pages/categories/index.astro";
const $$url$3 = "/categories.html";
...
const $$file$2 = "D:/Github/portafolio_cv/src/pages/categories/[category].astro";
const $$url$2 = "/categories/[category].html";
...
const Lix1 = new Proxy({"src":"/_astro/index1.f2a26686.png","width":1128,"height":619,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot3 = new Proxy({"src":"/_astro/index3.da0f051e.PNG","width":1366,"height":584,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Among1 = new Proxy({"src":"/_astro/index2.ac796ad6.png","width":1135,"height":634,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot1 = new Proxy({"src":"/_astro/index1.6f10fa68.PNG","width":1366,"height":319,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot2 = new Proxy({"src":"/_astro/index2.17e02015.PNG","width":1366,"height":320,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot4 = new Proxy({"src":"/_astro/index4.fc770ec6.PNG","width":1366,"height":584,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot5 = new Proxy({"src":"/_astro/index5.de186301.PNG","width":774,"height":505,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Dot6 = new Proxy({"src":"/_astro/index6.a79d3dd3.PNG","width":772,"height":508,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Among3 = new Proxy({"src":"/_astro/index3.6b77210d.png","width":1280,"height":720,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Among4 = new Proxy({"src":"/_astro/index4.13ae39e9.png","width":1280,"height":720,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Lix2 = new Proxy({"src":"/_astro/index2.b3f602e6.png","width":798,"height":592,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Lix3 = new Proxy({"src":"/_astro/index3.4eae3538.png","width":565,"height":315,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Lix4 = new Proxy({"src":"/_astro/index4.ef488372.png","width":497,"height":274,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Lix5 = new Proxy({"src":"/_astro/index5.4e75e9f2.png","width":799,"height":599,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const Lix6 = new Proxy({"src":"/_astro/index6.d63c6880.png","width":684,"height":317,"format":"jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
...
const ArrowIcon = (props) => {
  const { handleNext, direction } = props;
  return /* @__PURE__ */ jsx(
    IconButton,
    {
      variant: "text",
      ...
      size: "lg",
      onClick: handleNext,
      className: `!absolute top-2/4 ${direction === "left" ? "left-4" : "!right-4"} -translate-y-2/4 mix-blend-difference`,
      children: /* @__PURE__ */ jsx(
        "svg",
        {
          xmlns: "http://www.w3.org/2000/svg",
...
function CarouselComponent(props) {
  if (!props?.data)
    return null;
  const { keyId, otherImgs } = props.data;
  return /* @__PURE__ */ jsx(
    Carousel,
    {
      className: "rounded-xl md:w-9/12 w-full m-auto items-center",
      loop: true,
      autoplay: true,
      transition: { duration: 1, type: "tween" },
      prevArrow: ({ handlePrev }) => /* @__PURE__ */ jsx(ArrowIcon, { handleNext: handlePrev, direction: "left" }),
      nextArrow: ({ handleNext }) => /* @__PURE__ */ jsx(ArrowIcon, { handleNext, direction: "right" }),
      children: otherImgs && otherImgs.map((el, idx) => /* @__PURE__ */ jsx(
        "img",
        {
          src: el,
          alt: `${keyId}-${idx}`,
...
const $$project = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Base", $$Base, { "title": projectData?.title || "" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "PageHeader", $$PageHeader, { "title": projectData?.title || "", "id": projectData?.keyId, "url": projectData?.srcImg })} ${maybeRenderHead()}<div class="section-sm pb-0"> <div class="container my-8"> <p class="my-8">${projectData?.description}</p> <div class="row"> ${renderComponent($$result2, "CarouselComponent", CarouselComponent, { "data": projectData, "client:load": true, "client:component-hydration": "load", "client:component-path": "@/components/Carousel.component", "client:component-export": "default" })} </div> <p class="my-8">${projectData?.technicalDescription}</p> </div> </div> ` })}`;
}, "D:/Github/portafolio_cv/src/pages/projects/[project].astro", void 0);

const $$file$1 = "D:/Github/portafolio_cv/src/pages/projects/[project].astro";
const $$url$1 = "/projects/[project].html";
...
export { _category_ as _, index as a, _project_ as b, _tag_ as c, index$1 as i };
